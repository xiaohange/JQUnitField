...
@interface JQUnitField () <UIKeyInput>
...
- (instancetype)initWithInputUnitCount:(NSUInteger)count {
    if (self = [super initWithFrame:CGRectZero]) {
        NSCAssert(count > 0, @"JQUnitField must have one or more input units.");
        NSCAssert(count <= 9, @"JQUnitField can not have more than 9 input units.");
